...
class Interface_manga():
    ...
    def background_image(self):
        ...
        self.image_background = Image.open("background_manga.png")
...
interface_manga = Interface_manga()
interface_manga.background_image()
interface_manga.ajouter_titre()
interface_manga.colonne_salon()
interface_manga.case_texte()
interface_manga.btn_send()
interface_manga.btn_sport()
interface_manga.btn_cinema()
