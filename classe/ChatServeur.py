...
#             if channel[0] == client_socket:
#                 return channel[1] # Renvoie l'ID du canal associé au client_socket
#         return None

#     def get_channels(self):
#         query = "SELECT id, name, is_public FROM channels"
#         try:
#             with self.db.get_connection() as connection:
#                 cursor = connection.cursor()
...
#                     channel = (id, name, is_public)
#                     channels.append(channel)
#                 cursor.close()
#                 return channels
#         except mysql.connector.Error as err:
#             print("Error fetching channels:", err)
#             return []          
