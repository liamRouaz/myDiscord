...
class Interface_cinema():
    ...
    def background_image(self):
        ...
        self.image_background = Image.open("background_cinema.png")
...
interface_cinema.background_image()
interface_cinema.ajouter_titre()
interface_cinema.colonne_salon()
interface_cinema.case_texte()
interface_cinema.btn_send()
interface_cinema.btn_sport()
interface_cinema.btn_cinema()
interface_cinema.btn_manga()
interface_cinema.btn_disconnect()


interface_cinema.screen.mainloop() 
